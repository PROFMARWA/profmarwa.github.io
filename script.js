...
const socialPlatforms = [
    {
        ...
        icon: `<svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
            <path d="M21.9 3.2 2.8 10.6c-1.3.5-1.3 1.3-.2 1.6l4.9 1.5 1.9 5.9c.2.6.4.6.8.3l2.8-2.7 5.8 4.3c1.1.6 1.9.3 2.2-1l3.1-14.7c.4-1.4-.5-2-2-1.6zm-2.8 4.1-8.8 7.9-.3 3.1-.1-1.8-1.6-3.4 10.2-6.3c.5-.3.9-.1.6.5z"/>
        </svg>`,
...
function changeSocialButton() {
    ...
    socialDots.forEach((dot, index) => {
        dot.classList.toggle("active", index === currentPlatform);
    });

    /* الانتقال للمنصة التالية */
    currentPlatform++;
